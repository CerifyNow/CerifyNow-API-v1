    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Talaba'), ('admin', 'Muassasa Administratori'), ('superadmin', 'Super Administrator'), ('checker', 'Tekshiruvchi')], default='student', max_length=20, verbose_name='Rol')),
                ...
                ('institution_name', models.CharField(blank=True, max_length=255, verbose_name='Muassasa nomi')),
                ('institution_license', models.CharField(blank=True, max_length=100, verbose_name='Litsenziya raqami')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('university', models.CharField(blank=True, max_length=255, verbose_name='Universitet')),
