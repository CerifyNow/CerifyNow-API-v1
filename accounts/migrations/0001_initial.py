    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'Talaba'), ('organization', 'Tashkilot'), ('admin', 'Administrator')], default='student', max_length=20, verbose_name='Rol')),
                ...
                ('organization_name', models.CharField(blank=True, max_length=255, verbose_name='Tashkilot nomi')),
                ('organization_license', models.CharField(blank=True, max_length=100, verbose_name='Litsenziya raqami')),
                ('organization_address', models.TextField(blank=True, verbose_name='Tashkilot manzili')),
