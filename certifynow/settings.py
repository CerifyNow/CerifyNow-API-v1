...
WSGI_APPLICATION = 'certifynow.wsgi.application'

# Database - Updated for Django 5.0
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('DB_NAME', default='certifynow'),
...
# Static files (CSS, JavaScript, Images) - Updated for Django 5.0
STATIC_URL = '/static/'
...
# REST Framework Configuration - Updated for latest version
REST_FRAMEWORK = {
...
# JWT Configuration - Updated for latest version
SIMPLE_JWT = {
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@certifynow.uz')
SERVER_EMAIL = DEFAULT_FROM_EMAIL

# Blockchain Configuration (Mock)
BLOCKCHAIN_NETWORK = config('BLOCKCHAIN_NETWORK', default='ethereum_testnet')
BLOCKCHAIN_CONTRACT_ADDRESS = config('BLOCKCHAIN_CONTRACT_ADDRESS', default='0x1234567890abcdef')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CerifyNow API',
    'DESCRIPTION': 'Diploma va sertifikatlarni blokcheyn asosida tekshirish platformasi API',
    'VERSION': '2.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'Verification', 'description': 'Certificate verification'},
